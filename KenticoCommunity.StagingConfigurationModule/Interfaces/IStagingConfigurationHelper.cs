...
{
    /// <summary>
    /// Provide helper functions for the StagingConfigurationModule that check whether or not an IInfo object is of an excluded type, excluded child type, or a media file that belongs to an excluded library.
    /// </summary>
