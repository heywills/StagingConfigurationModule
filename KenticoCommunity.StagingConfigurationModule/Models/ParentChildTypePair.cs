namespace KenticoCommunity.StagingConfigurationModule.Models
{
    ...
    /// created it automatically includes its list of cms.userrole child objects. To reference that relationship, the
    /// ParentType would be "cms.role" and the child type would be "cms.userrole".
    /// </summary>
